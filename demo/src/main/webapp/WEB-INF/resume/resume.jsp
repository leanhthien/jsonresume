        ...
        <section class="col-md-3 card-wrapper profile-card-wrapper affix">
          ...
          <span class="profile-pic-container">
            ...
            <div class="name-and-profession text-center">
              <h3 itemprop="name" ><b>${product.name}</b></h3>
              <h5 class="text-muted" itemprop="jobTitle">${product.jobTitle}</h5>
            </div>
          </span>
                <hr/>
                        ...
                        <div class="info">
                            ...
                            <ul class="list-unstyled clear-margin">
                                <li class="card card-nested clearfix">
                                    <div class="content">
                                        <p class="clear-margin relative"><strong>CEO/President</strong>,&nbsp;<a
                                                href="http://piedpiper.com" target="_blank">Pied Piper</a></p>
                                        <p class="text-muted"><small><span
                                                class="space-right">Dec, 2013 - Dec, 2014</span><span><i
                                                class="icon-clock mr-5"></i>1 year</span></small></p>
                                        <div class="mop-wrapper space-bottom">
                                            <p>Pied Piper is a multi-platform technology based on a proprietary
                                                universal compression
                                                algorithm that has consistently fielded high Weisman Scores™ that are
                                                not merely competitive,
                                                but approach the theoretical limit of lossless compression.</p>
                                        </div>
                                        <ul>
                                            <li class="mop-wrapper">
                                                <p>Build an algorithm for artist to detect if their music was violating
                                                    copy right
                                                    infringement laws</p>
                                            </li>
                                            <li class="mop-wrapper">
                                            ...
                                            <li class="mop-wrapper">
                                                <p>Optimized an algorithm that holds the current world record for
                                                    Weisman Scores</p>
                                            </li>
                                        </ul>
                                    </div>
